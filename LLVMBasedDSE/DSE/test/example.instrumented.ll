...
entry:
  ...
  call void @__DSE_Load__(i32 4, i32* %z)
...
if.end:                                           ; preds = %if.then, %entry
  call void @__DSE_Load__(i32 12, i32* %retval)
